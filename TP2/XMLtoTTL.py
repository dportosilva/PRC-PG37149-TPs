...
for obra in root.findall('obra'):
    file.write('###  http://www.semanticweb.org/diegoporto/ontologies/2020/1/arquivo-musica-digital#' + obra.get('id') + '\n')
    ...
    for instrumento in obra.findall('instrumentos/instrumento'):
        file.write('###  http://www.semanticweb.org/diegoporto/ontologies/2020/1/arquivo-musica-digital#' + obra.get('id') + '-' + instrumento.find('designacao').text.replace(" ", "") +  '\n')
        ...
        file.write('###  http://www.semanticweb.org/diegoporto/ontologies/2020/1/arquivo-musica-digital#' + instrumento.find('partitura').get('path') + '\n')
